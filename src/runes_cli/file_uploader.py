...
class FileUploader:
    ...
    async def upload(self, file_path) -> str:
        ...
        storage_bucket_path_config = os.getenv(
            "DN_CLI_STORAGE_BUCKET",
            "https://storage.googleapis.com/byoc-file-transfer/",
        )
        file_name = os.path.basename(file_path)
        storage_bucket_path = storage_bucket_path_config.rstrip("/")
